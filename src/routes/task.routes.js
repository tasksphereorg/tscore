...
import { createTask, getAllTaskBySubjectDivision, getTaskById, updateTask, deleteTask, getSubjectTask } from "../controllers/task.controllers.js";
...
router.get("/get-subject-tasks/",verifyAccessToken,authorizeRoles("STUDENT"),getSubjectTask)
